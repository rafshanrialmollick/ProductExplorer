      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 text-sm">
          ...
          <p className="text-slate-300 text-xs leading-relaxed">
            <strong className="text-white">Explanation:</strong> We used{" "}
            ...
            to cache the filtered products array so filtering only re-evaluates
            when the products list, selected category, or debounced search query
            changes. Additionally,{" "}
            <code className="bg-slate-800 px-1.5 py-0.5 rounded text-indigo-300">
              useCallback()
            </code>{" "}
            was used to memoize event handlers passed down to child components.
          </p>
        </div>
      </div>
    </div>
